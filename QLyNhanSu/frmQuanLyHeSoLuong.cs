...
namespace QLyNhanSu
{
    public partial class frmQuanLyHeSoLuong : Form
    {
        ...
        {
            dataGridViewHSL.DataSource = exec.Import(path);
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                DataGridViewRow row = this.dataGridViewHSL.Rows[e.RowIndex];
        ...
        // load + format show
        private void frmQuanLyHeSoLuong_Load(object sender, EventArgs e)
        {
            load_data();
            trangthai_btn(true);
            trangthai_txt(true);

            dataGridViewHSL.Columns["id"].DisplayIndex = 0;
            dataGridViewHSL.Columns["ten"].DisplayIndex = 1;
            dataGridViewHSL.Columns["giatri"].DisplayIndex = 2;

            dataGridViewHSL.Columns[0].HeaderText = "ID";
            dataGridViewHSL.Columns[1].HeaderText = "Tên";
            dataGridViewHSL.Columns[2].HeaderText = "Giá trị";

            dataGridViewHSL.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            dataGridViewHSL.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            dataGridViewHSL.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        }
